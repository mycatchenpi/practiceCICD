...
namespace Shopping.Data
{
    public class CheckOutData
    {
        ...
        public static List<CheckOut> GetCheckOut(int id)
        {
            ...
            {
                conn.Open();
                string sql = @"SELECT p.Name,p.Description,p.Image,c.Date,c.Quantity,c.ActivationCode from Product p, CheckOut c where p.ProductID=c.ProductID and c.CustomerID=@CustomerID order by c.Date desc";
